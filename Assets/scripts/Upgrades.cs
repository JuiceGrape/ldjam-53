...
public class Upgrades : MonoBehaviour
{
    ...
    public Upgrade speed = new Upgrade("Max Speed", 10, 10.0f, 1.0f, 0.2f);
    public Upgrade accell = new Upgrade("Acelleration", 10, 10.0f, 1.0f, 0.5f);
    public Upgrade brake = new Upgrade("Braking Force", 10, 10.0f, 1.0f, 1.0f);
    public Upgrade turning = new Upgrade("TurningSpeed", 10, 10.0f, 1.0f, 0.1f);
